    ...
    <div className="w-full  text-[white] mx-auto">
      ...
      >
        <div className="flex justify-center items-center text-center  relative p-4 max-w-5xl mx-auto custom_hight">
          ...
          >
            Welcome to GPT, the Generative Pub Trivia game.|I'll ask you a series of questions about
            the following categories.|Remember, no using your cell phone, and please don't shout out
            your answers.
          </Typewriter>
        </div>
      </div>
          ...
          {showCategory ? (
            <div id="category" className="flex items-center justify-center">
              <div className="flex justify-center items-center text-center min-h-[80vh] relative font-semibold text-[36px] sm:text-[44px] md:text-[48px] w-full  leadig-[50px]">
                <Typewriter id="typewriter-category" started={stageNames[stage] == "game"}>
            ...
            >
              <Question
                question={gameCategories[currentCategoryIndex].Questions[currentQuestionIndex]}
